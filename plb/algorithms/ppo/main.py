...
def main():
    ...
    log_dir = os.path.expanduser('./logs/' + args.env_name)
        ...
        for step in range(args.num_steps):
            ...
            if done[0]:
                ...
                if episodes % 200 == 0:
                    ...
                    evaluate(actor_critic, ob_rms, envs, args.seed,
                             args.num_processes, eval_log_dir, device, test_info, test_times)
                    test_times += 1
                episodes_step = 0
            else:
                episodes_step += 1
                
            if (j * args.num_steps + step + 1) % 10000 == 0:
                train_times += 1
